...
for i in range(len(train_idx)):
    ...
    os.makedirs( "data/solve_data/data_faguangtuan_data_Lifetime (ns)/train/smiles2/"+str(i))
    ...
    torch.save(data1,"data/solve_data/data_faguangtuan_data_Lifetime (ns)/train/graph1/"+str(i)+'/graph_data.pt')
    ...
    file = open("data/solve_data/data_faguangtuan_data_Lifetime (ns)/train/smiles1/"+str(i)+"/text.txt","w")
    file.write(smiles1)
    file.close()
    file = open("data/solve_data/data_faguangtuan_data_Lifetime (ns)/train/smiles2/"+str(i)+"/text.txt","w")
    file.write(smiles2)
    file.close()
...
for i in range(len(test_idx)):
    #data[test_idx[i]]
    os.makedirs("data/solve_data/data_faguangtuan_data_Lifetime (ns)/test/smiles1/"+str(i))
    os.makedirs( "data/solve_data/data_faguangtuan_data_Lifetime (ns)/test/smiles2/"+str(i))
    ...
    torch.save(data1,"data/solve_data/data_faguangtuan_data_Lifetime (ns)/test/graph1/"+str(i)+'/graph_data.pt')
    ...
    file = open("data/solve_data/data_faguangtuan_data_Lifetime (ns)/test/smiles1/"+str(i)+"/text.txt","w")
    file.write(smiles1)
    file.close()
    file = open("data/solve_data/data_faguangtuan_data_Lifetime (ns)/test/smiles2/"+str(i)+"/text.txt","w")
    file.write(smiles2)
    file.close()
